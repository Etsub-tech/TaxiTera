...
import { Search, Clock, TrendingUp, Home, MapPin, ArrowLeft, ArrowRight, ChevronDown, Moon, Sun, User, History as HistoryIcon, LogOut } from 'lucide-react';
        ...
        {searchHistory.length > 0 && (
          <div className={`${isDarkMode ? 'bg-white/10 border-blue-300/40' : 'bg-white border-gray-200'} backdrop-blur-xl border rounded-lg p-8 mb-6`}>
            <div className="flex items-center gap-2 mb-6">
              ...
              <h2 className={`text-2xl ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Recent Searches</h2>
            </div>
